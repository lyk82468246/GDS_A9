...
class LidarControlledCar:
    def __init__(self, lidar_port='/dev/ttyAMA2', lidar_baudrate=230400, motor_pins=None, base_speed=60, start_button_pin=17):
        # 默认电机引脚配置
...
# 全局实例
lidar_car = LidarControlledCar(motor_pins=motor_pins, base_speed=40, start_button_pin=17)
